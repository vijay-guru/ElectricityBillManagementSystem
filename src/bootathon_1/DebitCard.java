...
public class DebitCard extends JFrame {
    ...
    public DebitCard(String to,String userName,String namel,String consnum,long receiptnumber){
       
        setBounds(520,300,500,365);  
        setLayout(null);  
        setVisible(true);
        setTitle(" Debit Card Payment ");
        Image icon=Toolkit.getDefaultToolkit().getImage("D:\\icon.png");
        setIconImage(icon);
       
        JLabel cc=new JLabel("Via Debit Card");
